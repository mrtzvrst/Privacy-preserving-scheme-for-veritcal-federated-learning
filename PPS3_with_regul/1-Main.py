...
Read = 'Synthetic' # Bank, Satellite, Robot, Synthetic
...
if Read=='Bank':
    ...
    input_dim, output_dim, epochs, batch_size = 36, 6, 600, 1000
    if not exists(Model_NT_name):
    ...
    input_dim, output_dim, epochs, batch_size = 10, 2, 1000, 1000
    if not exists(Model_NT_name):
