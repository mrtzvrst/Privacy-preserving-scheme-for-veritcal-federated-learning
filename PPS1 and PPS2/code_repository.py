...
def PPS1(k0_stp, i_stp, Num_of_Predictions, filename, STR, Truncate, Version, epochs, batch_size, accuracy, Model_NT_name):
        ...
        while i < t0:
            ...
            if exists(fn):
                ...
                while acc<accuracy:
                    ...
                    Final_model1 = train_LR(model1, epochs, optimizer1, CEF_loss1, Lambda, batch_size, x_tr, y_tr, x_vl, y_vl, np.random.randint(0, 1000, size=1)[0])
...
def PPS2(k0_stp, i_stp, Num_of_Predictions, filename, STR, Truncate, Version, epochs, batch_size, accuracy, Model_NT_name):
